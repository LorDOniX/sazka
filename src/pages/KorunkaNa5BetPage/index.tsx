...
export default function KorunkaNa5BetPage() {
	...
	return <Page>
		...
		<div className="korunkaNa5BetPage__numberWithSetHolder">
			<MyNumberWithSet min={KORUNKA_NA5.minDrawCount} text="Počet slosování" updatedValue={KORUNKA_NA5.drawCountUpdatedValue} value={state.drawCount} onChange={updateDrawCount} />
		</div>
		<MySelector className="korunkaNa5BetPage__priceSelector" values={KORUNKA_NA5.bets} value={state.bet} format={value => formatPrice(value as number)} onUpdate={(bet: number) => updateState({ bet })} />
		<div className="korunkaNa5BetPage__numberWithSetHolder">
